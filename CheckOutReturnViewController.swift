...
class CheckOutReturnViewController: UIViewController,UIPickerViewDelegate,UIPickerViewDataSource, AVCaptureMetadataOutputObjectsDelegate {
    ...
    @IBAction func checkOut(_ sender: UIButton) {
        ...
        let task = URLSession.shared.dataTask(with: request as URLRequest) {
            ...
            //create an alert
            let alert = UIAlertController(title: "Succesful", message: "Data has been captured and Inserted", preferredStyle: .alert)
